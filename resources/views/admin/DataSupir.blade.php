    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1">
            ...
            <div class="p-6">
                ...
                <button class="bg-green-500 text-white px-4 py-2 rounded mb-4"><i class="fas fa-plus mr-2"></i>Tambah Sopir</button>
                ...
                <table class="w-full bg-white rounded-lg overflow-hidden shadow-lg">
                    ...
                    <tbody>
                        <tr class="border-b">
                            <td class="py-3 px-4">
                                <!-- Foto Sopir -->
                                <img src="{{ asset('img/admin.png') }}" alt="Surono" class="w-12 h-12 rounded-full object-cover">
                            </td>
                            <td class="py-3 px-4">1</td>
                            <td class="py-3 px-4">Ahmad</td>
                            <td class="py-3 px-4">08129876543</td>
                            <td class="py-3 px-4">ahmad@example.com</td>
                            <td class="py-3 px-4">Jl. Merdeka No.10</td>
