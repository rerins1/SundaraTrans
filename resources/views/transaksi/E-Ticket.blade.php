            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <p><strong>Telepon:</strong> {{ $no_handphone }}</p>
                ...
                <div class="flex flex-col items-center justify-center border border-gray-300 rounded-lg p-4 bg-gray-50">
                    ...
                    <p class="text-sm mt-2 text-gray-700 text-center">Kode Booking: <span class="font-bold">{{ session('success', $kode_booking ?? 'Tidak tersedia') }}</span></p>
                </div>
            </div>
